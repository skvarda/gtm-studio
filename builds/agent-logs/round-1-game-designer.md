...
This is the FIRST round. Establish the foundational game vision.
...
Be decisive and specific. Every agent reads your brief. Sign off with: "— Orchestrator, Round 1"'\''"
Orchestrator,: -c: line 7: unexpected EOF while looking for matching `'\'''\''
...
/bin/sh: 76: Syntax error: Unterminated quoted string
