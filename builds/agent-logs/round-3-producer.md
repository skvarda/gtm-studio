...
The Co-Founder: A mysterious NPC who keeps to himself. You'\''\'\'''\''re not sure what he does. He doesn'\''\'\'''\''t interfere. (Late-game reveals possible — secret genius? Embezzler? Multiple paths.)
Early Game: Survive cash burn. First hiring choices — developer or salesperson? Build product or chase revenue?
Mid Game: Grow team, ship features, acquire customers, navigate mar


Your job: Write a scope & prioritization doc (200–300 words) covering:
1. What to BUILD this round (top 3 items max — be ruthless)
2. What to CUT or defer (specifically name things from other agents to cut)
3. Estimated complexity for each item (low/medium/high)
4. Non-negotiables — what absolutely must work for the round to be a success
5. Known risks or technical concerns

Your job is to prevent scope creep. The Developer can only do so much in one round. Pick the most impactful things and let the rest go.'"
/bin/sh: 118: Syntax error: Unterminated quoted string
