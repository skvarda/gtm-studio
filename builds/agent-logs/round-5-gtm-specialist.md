...
Endgame Paths (player may not know all at the start):
  1. IPO Glory — go public, maximize market cap
  2. Profit Machine — bootstrap to ma


Your job: Write a GTM & narrative design doc (200–350 words) covering:
1. The core "viral hook" — what players will tell their friends about
2. Key narrative beats or events for this round'\''s focus area
3. How the mystery co-founder NPC should evolve this round (keep it subtle)
4. One specific piece of dialog or UI text that captures the game'\''s tone
5. Any startup tropes or real GTM mechanics to incorporate authentically

Keep it grounded in real startup experience but wrapped in game comedy.'"
/bin/sh: 108: Syntax error: Unterminated quoted string
