...
function drawStation(s) {
    ...
    ctx.beginPath();
    ctx.ellipse(s.x, platformY + s.size * 0.8, s.s
...
/bin/sh: 257: Syntax error: Unterminated quoted string
